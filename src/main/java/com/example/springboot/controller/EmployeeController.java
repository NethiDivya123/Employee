...
public class EmployeeController {
	...
	{
		Employee employee=repo.findById(id).orElseThrow(()->new ResourceNotFoundException("Employee not exist"+id));
	...
	public ResponseEntity<Map<String,Boolean>>deleteEmployees(@PathVariable int id)
	{
		Employee employee=repo.findById(id).orElseThrow(()->new ResourceNotFoundException("Employee not exist"+id));
